...
from .views import register,CustomLoginView,profile_view,CustomLogoutView,update_user,view_participation,view_sponsorships,face_recognition_video
...
urlpatterns = [
    ...
    path('video/', face_recognition_video, name='face'),
