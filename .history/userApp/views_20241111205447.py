...
def update_user(request, pk):
    ...
    if request.method == 'POST':
        ...
        return render('userApp/UpdateProfile/UpdateProfiledate_user', {'user': user})  # Redirect to the user's profile or desired page
    return render('userApp/UpdateProfile', {'user': user})
