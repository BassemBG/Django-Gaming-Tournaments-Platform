...
SECRET_KEY = 'django-insecure-i_&*kn#1yb776i6gf(%5ew_h15^_-+%t5i_ej=$we$l386nw89'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "coreApp" / "Templates",  # Add your templates directory here
        ],
    },
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'timeout': 20,  # Increase timeout to 20 seconds (or any other suitable value)
        }
    }
}
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "coreApp" / "static",  # Adjusted path to include the users app static folder
    # You can add more directories here if necessary
]
...
RECAPTCHA_PUBLIC_KEY = '6Ld87okqAAAAAJ2xPS7qbGrrLg9vmvTZJgkWge7A'
RECAPTCHA_PRIVATE_KEY = '6Ld87okqAAAAACTaDfYsVGkgmh1wZn2utfl1h_gd'
